...
public class CuentaDAO implements Serializable {
    ...
    public CuentaDAO(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public List<Cuenta> findCuentaEntities(Persona user) {
        EntityManager em = getEntityManager();
        try {
            TypedQuery<Cuenta> query = em.createQuery("SELECT c FROM Cuenta c WHERE c.usuario = :persona", Cuenta.class);
