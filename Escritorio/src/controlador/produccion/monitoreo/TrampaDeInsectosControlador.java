...
public class TrampaDeInsectosControlador {
    ...
    public TrampaDeInsectos nuevo(Date fecha, String nombre, String especie, int individuos, boolean cambio, String observaciones) {
        return new TrampaDeInsectos(fecha, nombre, especie, individuos, cambio, observaciones);
    }
