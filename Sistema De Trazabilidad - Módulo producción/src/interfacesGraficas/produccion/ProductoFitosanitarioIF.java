 ...
 * @author fredy
 */
public class ProductoFitosanitarioIF extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProductoFitosanitarioIF
     */
    private ProductoFitosanitario registroSeleccionado = null;
    private ProductoFitosanitarioControlador controlador;
    private List<ProductoFitosanitario> lista;

    public ProductoFitosanitarioIF() {
        initComponents();
        controlador = new ProductoFitosanitarioControlador();
        guardar(false);
        cargarLista();
    }
    ...
    private void eliminarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarButtonActionPerformed
        ...
        if (principalTable.getSelectedRow() == -1) {
            ...
            for (ProductoFitosanitario pf : lista) {
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        if (registroSeleccionado == null) {
            ProductoFitosanitario nuevo = controlador.nuevo(nombreTextField.getText(), ingredienteTextField.getText(), (String) unidadesComboBox.getSelectedItem());
    ...
    private void cargarLista() {
        ...
        for (ProductoFitosanitario l : lista) {
