...
@Entity
public class InsumoFitosanitario implements Serializable {
    ...
    public InsumoFitosanitario() {
    }

    public InsumoFitosanitario(String nombre, String ingredienteActivo, String unidades) {
        this.nombre = nombre;
