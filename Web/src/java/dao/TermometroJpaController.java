 ...
 * @author fredy
 */
public class TermometroJpaController implements Serializable {

    public TermometroJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Termometro termometro) {
    ...
    public Termometro findTermometro(Long id) {
        EntityManager em = getEntityManager();
        try {
            return em.find(Termometro.class, id);
        } finally {
            em.close();
        }
    }
